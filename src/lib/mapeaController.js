// MAPEA Controller - React compatible (uses CONFIG and callbacks)
import { CONFIG } from '../config';

export class MAPEAController {
    constructor(options = {}) {
        this.map = null;
        this.centroidsLayer = null;
        this.footprintsLayer = null;
        this.wmsPhotoLayers = new Map();
        this.hoveredFootprintLayer = null;
        this.currentFlight = null;
        this.hoveredFeature = null;
        this.onFeatureClickCallback = null;
        this.tooltip = null;
        this.ckanService = options.ckanService;
        this.onLayersChange = options.onLayersChange || (() => {});
        this.getIsRemoveMode = options.getIsRemoveMode || (() => false);
        this.selectedFeatures = new Set();
        this.selectedFeatureData = new Map();
    ...
    async loadPhotoWMS(photoProperties) {
        try {
            ...
            if (this.wmsPhotoLayers.has(fotogramaId)) {
                ...
                const isRemoveMode = this.getIsRemoveMode();
            ...
            const fotogramaPackage = this.ckanService ? await this.ckanService.fetchPackageById(fotogramaId) : null;
